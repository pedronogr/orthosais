    ...
    <>
      ...
      <div className="bg-white py-4 border-b">
        <div className="container mx-auto px-4">
          <div className="flex items-center text-sm text-gray-600">
            ...
            <span className="mx-2">/</span>
            <span className="text-primary">Flandor 500mg</span>
          </div>
        </div>
      </div>
      ...
      <section id="informacoes" className="bg-gray-50 py-16">
        <div className="container mx-auto px-4 space-y-12">
          <div>
            <h3 className="text-2xl font-bold mb-6 text-center">Benefícios do Flandor 500mg</h3>
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white p-6 rounded-lg shadow-sm text-center">
                ...
                <h4 className="text-lg font-semibold mb-2">Potente Anti-inflamatório</h4>
                <p className="text-gray-600">Ajuda a reduzir inflamações no corpo, contribuindo para a saúde articular e alívio de desconfortos.</p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm text-center">
                ...
                <h4 className="text-lg font-semibold mb-2">Ação Antioxidante</h4>
                <p className="text-gray-600">Combate os radicais livres, retardando o envelhecimento celular e protegendo o corpo contra estresse oxidativo.</p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm text-center">
                ...
                <h4 className="text-lg font-semibold mb-2">Suporte Cardiovascular</h4>
                <p className="text-gray-600">Contribui para a saúde do sistema circulatório, auxiliando na manutenção dos níveis saudáveis de colesterol.</p>
              </div>
            </div>
          </div>
      ...
      {/* Banner promocional */}
      <PromotionBanner
        title="Oferta Especial - Combo Saúde"
        description="Na compra de Flandor 500mg + ViscoMove, ganhe 10% de desconto. Proteção completa para suas articulações!"
