  ...
  return (
    <div className="bg-background text-foreground leading-relaxed antialiased">
      ...
      <section className="container mx-auto px-4 py-10 flex flex-col md:flex-row items-center gap-8">
        ...
        />
        <div>
          <h2 className="text-2xl font-semibold mb-4">Fórmula avançada para a saúde das articulações</h2>
        ...
        <div className="container mx-auto px-4 space-y-8">
          ...
          <div>
            ...
            <p>
              ...
              umidade. Manter o frasco bem fechado e fora do alcance de crianças.
            </p>
          </div>
        </div>
      </section>
