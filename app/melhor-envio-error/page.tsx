...
export default function MelhorEnvioErrorPage() {
  ...
  useEffect(() => {
    // Obter a mensagem de erro da URL
    const error = searchParams.get('error') || 'Erro desconhecido na integração com o Melhor Envio';
    setErrorMessage(error);
    
    // Gerar URL de autorização para uma nova tentativa
